...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_lora_tacimg_realworld_replayed_task820_local",
        # 与 pi05_lora_tacimg_realworld_task820 完全相同，仅使用本地 replayed task820 数据和本地 pi05_base。
        model=pi0_config.Pi0Config(
            pi05=True,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=TaberoTacImgDataConfig(
            repo_id="realworld_replayed_task820",
            base_config=DataConfig(
                prompt_from_task=True,
            ),
            extra_delta_transform=True,
    ...
    TrainConfig(
        name="pi05_lora_tacimg_realworld_replayed_task820_force",
        model=pi0_config.Pi0Config(
            pi05=True,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=TaberoTacImgDataConfig(
            repo_id="realworld_replayed_task820_firm",
            base_config=DataConfig(prompt_from_task=True),
            assets=AssetsConfig(asset_id="pi05_horizon50_tacimg_task820_firm"),
            extra_delta_transform=True,
        ),
        batch_size=32,
        num_workers=2,
    ...
    TrainConfig(
        name="pi05_lora_tacfield_realworld_replayed_task820_firm_mixed_no_state",
        model=pi0_config.Pi0Config(
            pi05=True,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=TaberoTacFieldDataConfig(
            repo_id="xiangxin0923/realworld_replayed_task820",
            assets=AssetsConfig(asset_id="pi05_horizon50_tacfield_task820_firm_mixed"),
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=16,
    ...
    TrainConfig(
        name="pi0_lora_tacfield_tabero_xarm_gripper",
        model=pi0_config.Pi0Config(
            action_horizon=50,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
